...
class MemberOnlyIndex(Resource):
    ...
    def get(self):
        member_only_articles = Article.query.filter_by(is_member_only=1).all()
        index_articles = [index_article.to_dict() for index_article in member_only_articles]

        return index_articles, 200
